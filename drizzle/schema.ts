...
export const profiles = pgTable("profiles", {
  ...
  hourlyRate: numeric("hourlyRate", { precision: 12, scale: 2 }),
  ...
  serviceRadiusKm: numeric("serviceRadiusKm").default("50"),
  createdAt: timestamp("createdAt").defaultNow().notNull(),
  updatedAt: timestamp("updatedAt").defaultNow().notNull(),
}, (table) => ({
  userIdx: index("profiles_user_idx").on(table.userId),
  userUniqueIdx: uniqueIndex("profiles_user_id_unique").on(table.userId),
