...
export default function JobPosting() {
  ...
  const [form, setForm] = useState({ title: "", vocation: "", description: "", budget: "", location: "", deadline: "", currency: "NGN" as "NGN" | "ZAR", isUrgent: false });
  ...
  const publish = () => {
    createJob.mutate({ title: form.title.trim(), description: form.description.trim(), vocation: form.vocation, budget: preview.budget, currency: form.currency, location: form.location.trim(), deadline: form.deadline ? new Date(form.deadline).toISOString() : undefined, isUrgent: form.isUrgent });
  };
